            ...
            <div className="flex flex-col space-y-3 md-space-y-0 md:space-x-6 md:flex-row">
              ...
              <div>
                ...
                <p className="text-gray-700">
                  ...
                  You'll receive timely email notifications, and you can also
                  log in to our platform to track the progress of your
                  transaction, exchange messages, and receive updates, ensuring
