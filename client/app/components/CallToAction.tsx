    ...
    <section id="cta" className="bg-blue-500 mt-4">
      <div className="container flex flex-col items-center justify-between px-6 py-10 mx-auto space-y-12 md:py-12 md:flex-row md:space-y-0">
        ...
        <div>
          <Link
            href="/signup"
            className="p-3 px-6 pt-2 text-blue-700 bg-white shadow-2xl rounded-full baseline hover:bg-gray-900 md:block active:bg-transparent transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110"
          >
            Get Started
          </Link>
        </div>
